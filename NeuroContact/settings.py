"""
Django settings for NeuroContact project.
...
ROOT_URLCONF = "NeuroContact.urls"
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'app_datascience/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = "NeuroContact.wsgi.application"
